...
def  cqsim_main(para_list):
    ...
    save_name_bb = para_list['path_fmt'] + para_list['bb_save'] + para_list['ext_fmt_n']
    ...
    module_sim = Class_Cqsim_sim.Cqsim_sim(module=module_list, debug=module_debug, monitor = para_list['monitor'], is_training=para_list['is_training'])
