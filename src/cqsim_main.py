...
import Extend.SWF.bb_struc_SWF as bb_struc_ext
import Extend.SWF.Filter_bb_SWF as filter_bb_ext
...
def  cqsim_main(para_list):
    ...
    save_name_n = para_list['path_fmt'] + para_list['node_save'] + para_list['ext_fmt_n']  #para_list['node_save']:test_node  para_list['ext_fmt_n']:csv  boyang
    config_name_n = para_list['path_fmt'] + para_list['node_save'] + para_list['ext_fmt_n_c']
    save_name_bb = para_list['path_fmt'] + para_list['bb_save'] + para_list['ext_fmt_n']    #boyang
    config_name_bb = para_list['path_fmt'] + para_list['bb_save'] + para_list['ext_fmt_n_c']
    ...
    module_filter_node = filter_node_ext.Filter_node_SWF(struc=struc_name, save=save_name_n, config=config_name_n, debug=module_debug)  # boyang This is struct_name,{} ../data/InputFiles/test.swf
    ...
    #BB Filter
    print(".................... BB Filter")
    module_filter_bb = filter_bb_ext.Filter_bb_SWF(struc=struc_name, save=save_name_bb, config=config_name_bb,
                                                         debug=module_debug)
    module_filter_bb.read_bb_struc()
    module_filter_bb.output_bb_data()
    module_filter_bb.output_bb_config()
    ...
    module_node_struc.import_bb_file(save_name_bb)
    module_node_struc.import_bb_config(config_name_bb)
    #BB Structure
    '''
    print(".................... BB Structure")
    module_bb_struc = bb_struc_ext.bb_struc_SWF(debug=module_debug)
    module_bb_struc.import_bb_file(save_name_bb)
    module_bb_struc.import_bb_config(config_name_bb)
    '''
    # Backfill
    print(".................... Backfill")
