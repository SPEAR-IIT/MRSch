...
if __name__ == "__main__":
    ...
    p.add_option("--bb_save", dest="bb_save", type="string", \
                 help="file name of the formatted bb data")
    ...
    #print ("This is node_struc")    test.swf
    #print (inputPara_sys["node_struc"]) test.swf
    ...
    if not opts.bb_save:
        opts.bb_save = get_raw_name(opts.job_trace) + "_bb"   #boyang
    if not opts.bf_para:
        opts.bf_para = []
    ...
    inputPara['bb_save'] = opts.bb_save           #boyang
