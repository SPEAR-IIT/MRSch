...
class Job_trace:
    ...
    def node_wait_size_acc (self):
        #self.debug.debug("* "+self.myInfo+" -- wait_size",6)
        return self.node_wait_size

    def bb_wait_size_acc(self):
        # self.debug.debug("* "+self.myInfo+" -- wait_size",6)
        return self.bb_wait_size
    ...
    def job_submit (self, job_index, job_score = 0, job_est_start = -1):
        ...
        self.node_wait_size += self.jobTrace[job_index]["reqProc"]*self.jobTrace[job_index]["run"]
        self.bb_wait_size+=self.jobTrace[job_index]["reqMem"]*self.jobTrace[job_index]["run"]
        return 1
