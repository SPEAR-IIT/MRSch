...
class Cqsim_sim:
    ...
    def start_scan(self):
        ...
        while (i<wait_num):
            ...
            if (self.module['node'].is_available(temp_job['reqProc']) and self.module['node'].bb_is_available(temp_job['reqMem'])): # Boyang
                print ("Node available result",self.module['node'].is_available(temp_job['reqProc']))
                print("BB available result", self.module['node'].is_available(temp_job['reqProc']))
                print (temp_wait[i])
