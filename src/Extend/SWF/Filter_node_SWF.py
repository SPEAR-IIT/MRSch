...
class Filter_node_SWF(filter_node.Filter_node):
    ...
    def read_node_struc(self):
        ...
        # [['MaxNodes *:([^\\n]+)\\n', 'node'], ['MaxProcs *:([^\\n]+)\\n', 'proc']]  regexList boyang

        nodeFile = open(self.struc,'r') #test.swf boyang
        while (1):
        ...
        nodeFile.close()
        self.node_data_build(node_info)    #print This is node info,{} {'node': 100, 'proc': 100} Boyang
    ...
    def output_node_data(self):
        if not self.save:
            ...
            return
        # This is self.save,{} ../data/Fmt/test_node.csv boyang
        sep_sign = ";"
        f2=open(self.save,"w")
